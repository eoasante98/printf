...
unsigned int conv_di(va_list args, buff_t *out, unsigned char flgs, int wth, int prec, unsigned char len);
unsigned int conv_b(va_list args, buff_t *out, unsigned char flgs, int wth, int prec, unsigned char len);
unsigned int conv_u(va_list args, buff_t *out, unsigned char flgs, int wth, int prec, unsigned char len);
unsigned int conv_o(va_list args, buff_t *out, unsigned char flgs, int wth, int prec, unsigned char len);
